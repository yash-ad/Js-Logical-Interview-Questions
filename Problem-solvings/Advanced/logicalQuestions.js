...
// Describe how prototypal inheritance works in JavaScript and provide an example of creating objects and inheriting properties/methods using prototypes.
//:-Prototypal inheritance in javascript involves objects with inheriting properties and methods from other objects via their prototypes.
...
yash.greet(); //Hello , My name is Yash.
...
Animal.prototype.greet = function(){
  console.log(`This is a ${this.name} Animal`);
}

const tiger = new Animal('Tiger');


tiger.greet()//This is a Tiger Animal